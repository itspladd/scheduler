...
.add("Confirm", () => {
  return (
    <Confirm
      message="Do ye really want ta delete yer appointment?"
      onConfirm={action("onConfirm clicked")}
      onCancel={action("onCancel clicked")}
    />
  )
})
.add("Status", () => <Status message="Deletin'"/>)
.add("Error", () => <Error message="Could not shiver timbers" onClose={action("onClose triggered")}/>)
.add("Form: Edit", () => {
  return (
    <Form 
      name="Pladd"
